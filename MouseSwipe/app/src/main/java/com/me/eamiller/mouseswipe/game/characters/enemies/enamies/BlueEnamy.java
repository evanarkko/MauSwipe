 ...
 */
public class BlueEnamy extends Enamy {
    private static final int defaultVelocity = 10;
    public BlueEnamy(Context c, int x, int y, Mouse m) {
        super(c, x, y, m);
        setMovingImages(R.drawable.enamy_right_blue, R.drawable.enamy_left_blue);
